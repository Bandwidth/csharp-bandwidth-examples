    ...
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            return Content(string.Format("This app is ready to use<br/>Please configure your sip phone with account <b>{0}@{1}.bwapp.bwsip.io</b> and password <b>1234567890</b>." +
                " Please check if your sip client is online. Then press this button.<br/><form action=\"{3}\"><input type=\"submit\">Call me</input></form>", Common.UserName, Common.DomainName, Url.Action("CallToSip", "Home")));
        }
